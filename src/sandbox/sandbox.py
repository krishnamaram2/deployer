...
"sudo wget https://releases.hashicorp.com/terraform/0.14.10/terraform_0.14.10_openbsd_386.zip && sudo unzip terraform_0.14.10_openbsd_386.zip && sudo mv terraform /bin/ && sudo rm -rf ./terraform*",
