...
"sudo wget https://releases.hashicorp.com/terraform/0.12.24/terraform_0.14.7_linux_amd64.zip && sudo unzip terraform_0.14.7_linux_amd64.zip && sudo mv terraform /bin/ && sudo rm -rf ./terraform*",
